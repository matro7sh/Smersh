...
export class ImpactCreateComponent implements OnInit {
  ...
  constructor(private _snackBar: MatSnackBar, private impactService: impactsService ,private router: Router) { }
  ...
  onSubmit(form: NgForm) {
    this.impactService.insert(form.value).subscribe((res) => {
      console.log(res);
